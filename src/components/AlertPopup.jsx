...
export default function AlertPopup({
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center bg-black/60 backdrop-blur-[3px] px-4">
      ...
      {/* modal */}
      <div className="w-full max-w-[380px] rounded-2xl border border-[#D5D46F]/20 bg-[#56021F] p-7 shadow-[0_20px_60px_rgba(0,0,0,0.45)] animate-[popup_.2s_ease]">
        ...
        <button
          ...
          ${
            success
              ? "bg-white text-[#56021F]hover:opacity-90"
