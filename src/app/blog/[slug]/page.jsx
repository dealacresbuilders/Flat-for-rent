...
async function getBlogData(slug) {
  ...
  try {
    ...
    const res = await fetch(
      `https://deal-acres-backend.onrender.com/admin/blog/getBlogBySlug/${slug}?domain=www.flatforrentinfaridabad.com`,
      {
         cache: "force-cache",
...
export default async function Page({ params }) {
  ...
  return (
    <div className="bg-gradient-to-b from-[#f4e9ed] to-white"> 
